        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('admin.settings.password.update') }}" method="POST">
                    ...
                    <div class="form-group mb-3">
                        <label for="current_password" class="fw-bold">
                            Current Password
                        </label>
                ...
                >
                    ...
                    <div class="row align-items-center mb-3">
                        ...
                        <div class="col-md-9">
                            ...
                            <label for="profile_image" class="fw-bold">
    ...
    <div class="col-md-6 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-description">
                    Update your brand logo shown on the header navbar
                </p>
    ...
    <div class="col-md-6 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-description">
                    Update background image for the admin login screen
                </p>
    ...
    <div class="col-md-6 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-description">
                    Manage global meta tags and social share image
                </p>
                ...
                >
                    ...
                    <div class="form-group mb-3">
                        ...
                        <label for="meta_description" class="fw-bold">
                            Meta Description
                        </label>
